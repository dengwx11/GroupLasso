...
write.table(lamb_opt,"./lamb_opt_1000", col.names = F, row.names = F,quote = F)
write.table(FDR_I,"./FDR_I_1000", col.names = F, row.names = F,quote = F)
write.table(FDR_G,"./FDR_G_1000", col.names = F, row.names = F,quote = F)
write.table(FNR_I,"./FNR_I_1000", col.names = F, row.names = F,quote = F)
write.table(FNR_G,"./FNR_G_1000", col.names = F, row.names = F,quote = F)
write.table(TP_I,"./TP_I_1000", col.names = F, row.names = F,quote = F)
write.table(TP_G,"./TP_G_1000", col.names = F, row.names = F,quote = F)
write.table(cnt_I,"./cnt_I_1000", col.names = F, row.names = F,quote = F)
write.table(MSE_G,"./MSE_G_1000", col.names = F, row.names = F,quote = F)
write.table(MSE_base,"./MSE_base_1000", col.names = F, row.names = F,quote = F)
write.table(main_inter_ratio,"./main_inter_ratio_1000",row.names = F,quote = F)

save(FDR_record_I,file="./FDR_record_I_1000.RData")
save(FDR_record_G,file="./FDR_record_G_1000.RData")
save(FNR_record_I,file="./FNR_record_I_1000.RData")
save(FNR_record_G,file="./FNR_record_G_1000.RData")
save(TDR_record_I,file="./TDR_record_I_1000.RData")
save(TDR_record_G,file="./TDR_record_G_1000.RData")
save(TPR_record_I,file="./TPR_record_I_1000.RData")
save(TPR_record_G,file="./TPR_record_G_1000.RData")
save(compare_sign_G_total, file="./compare_sign_G_1000.RData")
save(compare_sign_I_total, file="./compare_sign_I_1000.RData")
