...
# Signal/Noise Ratio
signal_to_ratio<-c(0.5,1,5,10,100)
...
save(FDR_record_I,file="./FDR_record_I_30.RData")
save(FDR_record_G,file="./FDR_record_G_30.RData")
save(FNR_record_I,file="./FNR_record_I_30.RData")
save(FNR_record_G,file="./FNR_record_G_30.RData")
save(TDR_record_I,file="./TDR_record_I_30.RData")
save(TDR_record_G,file="./TDR_record_G_30.RData")
save(TPR_record_I,file="./TPR_record_I_30.RData")
save(TPR_record_G,file="./TPR_record_G_30.RData")
