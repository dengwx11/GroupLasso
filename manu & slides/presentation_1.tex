...
\title[Patient Subgroup Selection]{Generalized Overlapping Group Lasso for Patient Subgroup Selection} % The short title appears at the bottom of every slide, the full title is only on the title page
